...
class CheckedOutTeachers extends StatefulWidget {
  ...
  @override
  State<CheckedOutTeachers> createState() => _CheckedOutTeachersState();
}

class _CheckedOutTeachersState extends State<CheckedOutTeachers> {
  ...
  void _onRefresh() async {
    await attendanceController.checkedOutTeachers(date: null);
    ...
    return Obx(() => Column(
          children: [
            ...
            Padding(
              ...
              attendanceController.teacherGoneHome.isEmpty && attendanceController.isCheckedOutTeacher.isFalse
                    ? Expanded(
            ...
            attendanceController.isCheckedOutTeacher.isFalse
                ? Expanded(
                    child: SmartRefresher(
